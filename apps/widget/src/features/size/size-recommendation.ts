...
export interface SizeRecommendation {
  ...
  alternative?: string;
  /** Punteggio di confidenza 0–100 (Story 9.3). */
  score: number;
}
...
/**
 * Distanza non pesata (retro-compatibile con Story 4.2): usata per scegliere
 * la taglia più vicina e l'ordinamento, indipendentemente dalla categoria.
 */
